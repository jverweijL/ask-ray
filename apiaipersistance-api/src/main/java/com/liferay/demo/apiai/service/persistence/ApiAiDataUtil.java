...
package com.liferay.demo.apiai.service.persistence;
 ...
 * @see com.liferay.demo.apiai.service.persistence.impl.ApiAiDataPersistenceImpl
 * @generated
 */
@ProviderType
public class ApiAiDataUtil {
	...
	*/
	public static ApiAiData findByUuid_First(String uuid,
		OrderByComparator<ApiAiData> orderByComparator)
		throws com.liferay.demo.apiai.exception.NoSuchApiAiDataException {
	...
	*/
	public static ApiAiData fetchByUuid_First(String uuid,
		OrderByComparator<ApiAiData> orderByComparator) {
	...
	* @throws NoSuchApiAiDataException if a matching api ai data could not be found
	*/
	public static ApiAiData findByUuid_Last(String uuid,
		OrderByComparator<ApiAiData> orderByComparator)
		throws com.liferay.demo.apiai.exception.NoSuchApiAiDataException {
	...
	*/
	public static ApiAiData fetchByUuid_Last(String uuid,
		OrderByComparator<ApiAiData> orderByComparator) {
	...
	* @throws NoSuchApiAiDataException if a matching api ai data could not be found
	*/
	public static ApiAiData findByUuid_C_First(String uuid, long companyId,
		OrderByComparator<ApiAiData> orderByComparator)
		throws com.liferay.demo.apiai.exception.NoSuchApiAiDataException {
		return getPersistence()
	...
	* @return the first matching api ai data, or <code>null</code> if a matching api ai data could not be found
	*/
	public static ApiAiData fetchByUuid_C_First(String uuid, long companyId,
		OrderByComparator<ApiAiData> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchApiAiDataException if a matching api ai data could not be found
	*/
	public static ApiAiData findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<ApiAiData> orderByComparator)
		throws com.liferay.demo.apiai.exception.NoSuchApiAiDataException {
		return getPersistence()
	...
	* @return the last matching api ai data, or <code>null</code> if a matching api ai data could not be found
	*/
	public static ApiAiData fetchByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<ApiAiData> orderByComparator) {
		return getPersistence()
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(ApiAiDataPersistence.class);

		ServiceTracker<ApiAiDataPersistence, ApiAiDataPersistence> serviceTracker =
			new ServiceTracker<ApiAiDataPersistence, ApiAiDataPersistence>(bundle.getBundleContext(),
				ApiAiDataPersistence.class, null);
