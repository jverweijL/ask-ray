 ...
 *
 * <p>
 * This class exists only as a container for the default extended model level methods generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ApiAiDataImpl}.
 * </p>
 *
...
public abstract class ApiAiDataBaseImpl extends ApiAiDataModelImpl
	...
	public void persist() {
		if (this.isNew()) {
			ApiAiDataLocalServiceUtil.addApiAiData(this);
		}
		else {
