...
describe('getPlugins()', function () {
	...
	it('supports legacy package configurations correctly', function () {
		process.chdir(projectDir + '/packages/liferay-npm-bundler/src/__tests__/config/' + 'legacy-packages');
		cfg.reloadConfig();
...
describe('getPluginVersions()', function () {
	it.only('analyzes default config correctly', function () {
